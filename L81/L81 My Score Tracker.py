...
# plt.grid(True)    -- adds faint grindlines so values are easier to read
...
#All four style options go inside the same plt.polt() call.
...
# the same title, lables, and ylim commands work exactly the same way
