...
conn = sqlite3.connect(r"C:\Users\rahma\OneDrive\Desktop\Rahm backup\L76\cities.db")
...
# Columns with a DEFAULT can be left out - the deafault fills in.
# conn.connit() saves all inserts permeanently

conn.execute("INSERT INTO City VALUES (1, 'Tokyo', 'Japan',  13960000, 'Yes');")
conn.execute("INSERT INTO City VALUES (2, 'Nairobi', 'Kenya',  43970000, 'Yes');")
