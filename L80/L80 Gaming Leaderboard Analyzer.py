...
players = pd.Series(scores, index=["NightWolf", "StarBlaze", "PixelKing", "CyberFox", "IronStrom"])
...
full_df = pd.read_csv(r"C:\Users\rahma\OneDrive\Desktop\Rahm backup\L80\leaderboard.csv")
